...
public readonly struct TrimOptions
{
    ...
    public static readonly TrimOptions Max;
    public static readonly TrimOptions MaxStart;
    public static readonly TrimOptions MaxEnd;
    ...
    static TrimOptions()
    {
        Min = new(TrimSide.StartEnd, WhiteSpace);
        MinStart = Min.WithStart();
        MinEnd = Min.WithEnd();

        Max = new(TrimSide.StartEnd, WhiteSpaces);
        MaxStart = Max.WithStart();
        MaxEnd = Max.WithEnd();
    }
    ...
    public TrimOptions(TrimSide side, bool[] map)
    {
        if (map == null) throw new ArgumentNullException(nameof(map));
        if (map.Length != 256) throw new ArgumentOutOfRangeException(nameof(map));
        if (side != TrimSide.Start && side != TrimSide.End && side != TrimSide.StartEnd)
    ...
    public TrimOptions WithSide(TrimSide side)
    {
        if (side != TrimSide.Start && side != TrimSide.End && side != TrimSide.StartEnd)
            throw new ArgumentOutOfRangeException(nameof(side));
...
/*255*/false];
    ...
    private static readonly bool[] WhiteSpaces = [
/*0*/false,
/*1*/false,
/*2*/false,
/*3*/false,
