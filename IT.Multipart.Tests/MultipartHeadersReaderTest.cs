...
internal class MultipartHeadersReaderTest
{
    ...
    public void ReadNextHeaderTest()
    {
        ...
        Assert.That(reader.ReadNextHeader(out var header, trimValue: false), Is.EqualTo(MultipartReadingStatus.Done));
        ...
        Assert.That(reader.ReadNextHeader(out header, trimValue: false), Is.EqualTo(MultipartReadingStatus.Done));
